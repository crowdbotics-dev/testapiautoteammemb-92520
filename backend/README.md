...
## Project Structure
    ...
    ├── testapiautoteammemb_92520  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_92520`
...
2. Clone this repo and `cd testapiautoteammemb_92520`
